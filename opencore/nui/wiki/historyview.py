...
from opencore.nui.wiki.interfaces import IWikiHistoryCache
...
class WikiVersionView(WikiBase): 
    ...
    def get_versions(self):
        ...
        """
        return IWikiHistoryCache(self.context)
...
def wiki_page_edited(page, event):
    IWikiHistoryCache(page).new_history_item()

annot_key = 'opencore.nui.wiki.wikihistory'

class WikiHistoryCache(object):
    ...
    def new_history_item(self):
        ...
        try:
            ...
            history = IWikiHistoryCache(first_item.object)
