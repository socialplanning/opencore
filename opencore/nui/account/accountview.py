...
class ForgotLoginView(AccountView):
    ...
    def userid(self):
        ...
        if not brains:
            self.addPortalStatusMessage(_(u'psm_cant_find_account', u"We can't find your account. This could be because you have not yet completed your email confirmation."))
            return
