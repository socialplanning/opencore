  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --   that way.
    --
    --  $HeadURL: http://svn.xinha.webfactional.com/tags/0.92beta/modules/Gecko/Gecko.js $
    --  $LastChangedDate: 2007-02-07 17:34:49 -0500 (Wed, 07 Feb 2007) $
...
Gecko._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.webfactional.com/tags/0.92beta/modules/Gecko/Gecko.js $".replace(/^[^:]*: (.*) \$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
