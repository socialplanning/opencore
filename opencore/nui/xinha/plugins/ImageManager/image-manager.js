...
HTMLArea.prototype._insertImage = function(image) {
    ...
    {
        manager += '&backend_config=' + encodeURIComponent(editor.config.ImageManager.backend_config);
        manager += '&backend_config_hash=' + encodeURIComponent(editor.config.ImageManager.backend_config_hash);
        manager += '&backend_config_secret_key_location=' + encodeURIComponent(editor.config.ImageManager.backend_config_secret_key_location);
    }
