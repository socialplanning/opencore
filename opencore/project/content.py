...
class OpenProject(BrowserDefaultMixin, TeamSpace):
    ...
    def _initializeProject(self, request):
        """
        This is called by the add view to perform after creation
        ...
        if assign_team:
            self._createTeam()
        self._createIndexPage()
        # Set initial security policy
        policy_writer = IWriteWorkflowPolicySupport(self)
