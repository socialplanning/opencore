...
# Original workflow id/title: medium_folder_openplans_workflow/OpenPlans Folder Workflow [Plone]
# Date: 2007/08/09 15:01:53.889 GMT-4
#
...
def setup_medium_folder_openplans_workflow(wf):
    """Setup the workflow
    """
...
def create_medium_folder_openplans_workflow(id):
    """Create, setup and return the workflow.
    """
    ob = DCWorkflowDefinition(id)
    setup_medium_folder_openplans_workflow(ob)
    return ob

addWorkflowFactory(create_medium_folder_openplans_workflow,
                   id='medium_folder_openplans_workflow',
                   title='Medium OpenPlans Folder Workflow [Plone]')
