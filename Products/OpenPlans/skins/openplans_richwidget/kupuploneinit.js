...
function restrictTextFormat(textarea) {
    // Patch for bad AT format pulldown.
    var fmtname = textarea.name+'_text_format';
    var pulldown = textarea.form[fmtname];
...
function initPloneKupu(editorId, showing) {
    ...
    var kupu = new KupuEditor(doc, conf, l, showing);
