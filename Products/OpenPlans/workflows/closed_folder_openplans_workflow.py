...
# Original workflow id/title: closed_folder_openplans_workflow/OpenPlans Folder Workflow [Plone]
# Date: 2007/08/09 15:00:22.204 GMT-4
#
...
def setup_closed_folder_openplans_workflow(wf):
    """Setup the workflow
    """
...
def create_closed_folder_openplans_workflow(id):
    """Create, setup and return the workflow.
    """
    ob = DCWorkflowDefinition(id)
    setup_closed_folder_openplans_workflow(ob)
    return ob

addWorkflowFactory(create_closed_folder_openplans_workflow,
                   id='closed_folder_openplans_workflow',
                   title='Closed OpenPlans Folder Workflow [Plone]')
