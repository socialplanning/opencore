...
# Date: 2007/06/01 15:03:17.511 GMT-7
#
...
def setup_openplans_team_workflow(wf):
    """Setup the workflow
    """
...
def create_openplans_team_workflow(id):
    """Create, setup and return the workflow.
    """
    ob = DCWorkflowDefinition(id)
    setup_openplans_team_workflow(ob)
    return ob

addWorkflowFactory(create_openplans_team_workflow,
