...
# Original workflow id/title: medium_policy_workflow/Medium Security Policy Workflow
# Date: 2006/10/03 16:13:55.056 GMT-7
#
...
def setup_medium_policy_workflow(wf):
    """Setup the workflow
    """
    wf.setProperties(title='Medium Security Policy Workflow')
...
def create_medium_policy_workflow(id):
    """Create, setup and return the workflow.
    """
    ob = DCWorkflowDefinition(id)
    setup_medium_policy_workflow(ob)
    return ob

addWorkflowFactory(create_medium_policy_workflow,
                   id='medium_policy_workflow',
                   title='Medium Security Policy Workflow')
